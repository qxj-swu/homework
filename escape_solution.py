class Edge:
    def __init__(self, to, rev, cap):
        ...
        self.rev = rev
        self.cap = cap
        self.original_cap = cap  # Track original capacity for path recovery
...
def solve_escape(n, starts):
    ...
    # Map from node ID to grid coordinates
    node_to_grid = {}
    start_to_node = {}
...
if __name__ == "__main__":
    ...
    can_escape, paths = solve_escape(n, starts)
    print(f"Can escape: {can_escape}")

    if can_escape:
        print(f"Found {len(paths)} escape paths:")
